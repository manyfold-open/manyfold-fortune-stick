...
export const en = {
  ...
  privacyCloudflare:
    'The site, Worker, and D1 run on Cloudflare. wrangler.jsonc also enables Cloudflare Worker observability, so Cloudflare may process request metadata, logs, and metrics under its platform service; this app adds no analytics or behavioural tracking.',
  ...
  statsFromTarotDrew: 'of them drew',
  ...
  statsFromShareDrew: 'of share visitors drew',
  statsTarotBreakdown:
