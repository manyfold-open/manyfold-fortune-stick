...
export const zh = {
  ...
  statsFromShareDrewCard: '分享进来后求签',
  statsCardDrawsDetail: '最近 {n} 天',
  statsCardDrew: '其中 {n} 人求签（{rate}）',
  statsCardShareDetail: '扫码 {qr} · 链接 {link} · 旧分享 {old}',
  statsCardRate: '占分享进来的 {rate}',
  statsCardClaims: '发出塔罗奖励 {n} 个',
  statsCardSharesDetail: '分享面板 {sent} · 下载图片 {saved}',
  statsDraws: '求签数',
  statsFromTarot: '从塔罗来',
  statsToTarot: '点去塔罗',
  statsClaims: '发出塔罗奖励',
